package com.sheikhrasik.android.youtubeplayer
...
const val YOUTUBE_VIDEO_ID = "DPR3p3EJADo"
const val YOUTUBE_PLAYLIST = "PL6gx4Cwl9DGAKWClAD_iKpNC0bGHxGhcx"
...
//        layout.addView(button1)
    ...
    private val playerStateChangeListener = object: YouTubePlayer.PlayerStateChangeListener {
        ...
        override fun onVideoEnded() {
            Toast.makeText(this@YoutubeActivity, "Congratulations!! You have completed yet another video.", Toast.LENGTH_LONG).show()        }
